...
project = 'cartopy'
copyright = '2011 - 2012 British Crown Copyright' # the template will need updating if this is changed
...
texinfo_documents = [
  ('index', 'cartopy', 'cartopy Documentation',
   'Philip Elson, Richard Hattersley', 'cartopy', 'One line description of project.',
   'Miscellaneous'),
]
